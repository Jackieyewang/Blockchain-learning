...
/***/ "./src/declarations/helloicp/helloicp.did.js":
/*!***************************************************!*\
  !*** ./src/declarations/helloicp/helloicp.did.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/helloicp/index.js":
/*!********************************************!*\
  !*** ./src/declarations/helloicp/index.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _helloicp_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "helloicp": () => (/* binding */ helloicp)
/* harmony export */ });
...
/* harmony import */ var _helloicp_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helloicp.did.js */ "./src/declarations/helloicp/helloicp.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./helloicp.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_helloicp_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the helloicp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./helloicp.did.js")._SERVICE>}
 */
 const helloicp = createActor(canisterId);
...
"use strict";
/*!******************************************!*\
  !*** ./src/helloicp_assets/src/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_helloicp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/helloicp */ "./src/declarations/helloicp/index.js");


document.getElementById("clickMeBtn").addEventListener("click", async () => {
  const name = document.getElementById("name").value.toString();
  // Interact with helloicp actor, calling the greet method
  const greeting = await _declarations_helloicp__WEBPACK_IMPORTED_MODULE_0__.helloicp.greet(name);
